                ...
                <x-jet-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div>{{ Auth::user()->nama }}</div>

                                <div class="ml-1">
                                    <img class="h-8 w-8 rounded-full object-cover" src="../assets/img/profile.png" alt="{{ Auth::user()->nama }}" />
                                </div>
                            </button>
                        @else
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="../assets/img/profile.png" alt="{{ Auth::user()->name }}" />
                </div>
