            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                ...
                @foreach($users as $key => $user)
                    ...
                    <td class="px-2 py-4 whitespace-nowrap text-center text-sm font-medium">
                        <a wire:model="edit({{$user->id}})" class="margin-right-custom custom-blue"><i class="fas fa-user-edit"></i></a>
                        <a wire:model="delete({{$user->id}})" class="margin-left-custom custom-red"><i class="fas fa-trash-alt"></i></a>
                    </td>
                    </tr>
                @endforeach
                </tbody>
