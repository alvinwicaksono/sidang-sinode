        ...
        <div class="mb-10">
            <form>
                <div class="bg-white px-8 pt-7 pb-6 sm:p-6 sm:pb-4">
                    <div class="mb-4 ">
                        <h3 class="text-center font-bold">Edit Artikel Sidang Seksi</h3>
                        <hr>
                    </div>
                    ...
                    <div class="mb-2">
                            <label for="repo_bId" class="block">repo_bId</label>
                            <input wire:model="repo_bId" disabled type="text" placeholder="Masukan repo_bId Materi" name="repo_bId" class="shadow appearance-none border rounded w-full mb-2 py-2 px-3 text-black">
                    </div>
