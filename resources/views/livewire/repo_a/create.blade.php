        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            <form>
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="mb-4 ">
                        <h3 class="text-center font-bold">Tambah Repositori A</h3>
                        <hr>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mb-2">
                            ...
                            @error('sumber_materi') <span class="error custom-red"><i class="fas fa-exclamation-circle"></i> {{ $message }}</span> @enderror
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input wire:model="attachment" type="file"  accept="image/*" placeholder="Tambah File" name="attachment" class="shadow appearance-none border rounded w-full mb-2 py-2 px-3 text-black">
